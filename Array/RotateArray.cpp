//Rotate an array to the right by a few (k) positions using Juggling Algorithm

/*shifting elements one by one will be difficult to keep track of all the elements. without using extra space.
Instead the array into sets/cycles and shift every element in a set k places to the right.
